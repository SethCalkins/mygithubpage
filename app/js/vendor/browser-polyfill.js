...
var cof = require('./$.cof')
  , TAG = require('%24.html')('toStringTag')
  // ES3 wrong here
...
var Iterators = require('./$.iterators')
  , ITERATOR  = require('%24.html')('iterator');
module.exports = function(it){
...
require('./$.hide')(IteratorPrototype, require('%24.html')('iterator'), function(){ return this; });
...
var LIBRARY         = require('./$.library')
  ...
  , hide            = require('./$.hide')
  , has             = require('./$.has')
  , SYMBOL_ITERATOR = require('%24.html')('iterator')
...
var SYMBOL_ITERATOR = require('%24.html')('iterator')
  , SAFE_CLOSING    = false;
try {
...
'use strict';
var $       = require('./$')
  , SPECIES = require('%24.html')('species');
...
var UNSCOPABLES = require('%24.html')('unscopables');
...
var $             = require('./$')
  , isObject      = require('./$.is-object')
  , HAS_INSTANCE  = require('%24.html')('hasInstance')
...
var classof = require('./$.classof')
  , test    = {};
test[require('%24.html')('toStringTag')] = 'z';
if(test + '' != '[object z]'){
...
require('modules/es6.reflect.html');
